<%-- 
    ...
    Created on : 13/04/2019, 07:29:14 PM
    Author     : Fernando
--%>
...
<html>
    ...
    <body>
        <h1 style = font-family:Arial>Registro Usuario Invitado</h1>
        <form action = "SignUp" method = "post">
            ...
            <input type = "text" name = "registro" placeholder = "Fecha de Registro"><br><br>
            <input type = "submit" value = "Registrarse"><br><br>          
            <div style = font-family:Arial><a href = "login .jsp">Iniciar Sesión</a></div>    
            <input type = "hidden" name = "Invitado">
        </form>
    </body>
</html>